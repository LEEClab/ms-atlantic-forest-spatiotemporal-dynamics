...
download.file(url = "https://d1gam3xoknrgr2.cloudfront.net/current/WDPA_WDOECM_Nov2022_Public_SA_shp.zip",
              destfile = "01_data/04_protected_areas/00_raw/WDPA_WDOECM_Nov2022_Public_SA_shp.zip", mode = "wb")
...
unzip(zipfile = "01_data/04_protected_areas/00_raw/WDPA_WDOECM_Nov2022_Public_SA_shp_1.zip",
      exdir = "01_data/04_protected_areas/00_raw/WDPA_WDOECM_Nov2022_Public_SA_shp_1")

unzip(zipfile = "01_data/04_protected_areas/00_raw/WDPA_WDOECM_Nov2022_Public_SA_shp_2.zip",
      exdir = "01_data/04_protected_areas/00_raw/WDPA_WDOECM_Nov2022_Public_SA_shp_2")
